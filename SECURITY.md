...
- GitHub's private vulnerability reporting, if enabled on the affected repository (Security tab, "Report a vulnerability").
- Contact via [info@fabian-arndt.dev](mailto:info@fabian-arndt.dev).
